...
class FPN(nn.Module):
    ...
    def __init__(self, num_blocks, num_classes, back_bone='resnet', pretrained=True):
        ...
        self.back_bone = torchvision.models.resnet50(pretrained=pretrained)
...
if __name__ == "__main__":
    model = FPN([2,4,23,3], 150)
    print('fuse paramters: ', get_parameter_number(model))
    print('fuse paramters: ', get_parameter_number(model.back_bone))
