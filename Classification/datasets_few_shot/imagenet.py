...
class ImageNet():
    ...
    def __init__(self, num_shots, preprocess):
        root = '/data/dataset_4_all_users/'
        ...
        self.train_x = torchvision.datasets.ImageNet(self.image_dir, split='train', transform=train_preprocess)
